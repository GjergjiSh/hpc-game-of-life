...
But one issue that I noticed close to the end, is that nearly all of our benchmarks were made using a board with just one glider.
...
% avenues: 
% * better profiling of CPU with intel advisor, `perf` etc
% * extension of game of life to recognize loops etc
